...
const verificarSolapamientos = async (nuevaFuncion, funcionExistente = null) => {
    ...
    console.log("Tiempo de limpieza entre funciones:", tiempoLimpieza);
    ...
    console.log("Duración de la nueva película:", duracionNuevaPelicula, "minutos");
...
export const updateOne = async (id, data) => {
    ...
    if (data.fechaHoraFuncion || data.idSala || data.idPelicula) {
        ...
        await verificarSolapamientos(datosParaValidar, funcionExistente);
    }
