...
export const errorHandler = (err, req, res, next) => {
  ...
  if(err.code === "P2002") {
    ...
    err.message = "Error: violación de unicidad."  + " Record: " + err.meta.modelName; // Mensaje de error personalizado
  } 
  if(err.code === "P2003") {
    ...
    err.message = "Error: registro relacionado no encontrado."  + " Record: " + err.meta.modelName; // Mensaje de error personalizado
  }
  if (err.code === "P2025") {
