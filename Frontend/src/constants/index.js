...
export const CLASIFICACIONES_MPAA = [
  ...
  { value: "PG", label: "PG - Se recomienda supervision parental", description: "Parental Guidance Suggested" },
  { value: "PG-13", label: "PG-13 - Mayores de 13 anos", description: "Parents Strongly Cautioned" },
