  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (onLogin) {
        ...
        if (!result.success) {
          setAlertMessage(result.error || 'Error en el login');
          setShowAlert(true);
        }
      }
    } catch (error) {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-3 rounded-lg border transition-colors outline-none ${
                  errors.email 
                    ? 'bg-slate-700 border-red-500 text-white placeholder-gray-400 focus:border-red-400 focus:ring-2 focus:ring-red-500/20' 
