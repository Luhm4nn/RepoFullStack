...
const ErrorModal = ({ error, onClose }) => {
  ...
  const getTitle = (type) => {
    switch (type) {
      case 'FECHA_ESTRENO_INVALIDA':
        return 'Fecha de Estreno Inválida';
      case 'SOLAPAMIENTO_FUNCIONES':
  ...
  const getDescription = (type) => {
    switch (type) {
      case 'FECHA_ESTRENO_INVALIDA':
        return 'No puedes programar una función antes del estreno de la película.';
      case 'SOLAPAMIENTO_FUNCIONES':
        return 'Por favor, selecciona un horario diferente que no se solape con otras funciones.';
      default:
        return 'Ha ocurrido un error. Por favor, revisa los datos e inténtalo nuevamente.';
    }
  };
