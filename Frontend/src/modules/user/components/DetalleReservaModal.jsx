    ...
    const cargarAsientos = async () => {
      ...
      try {
        ...
        const asientosReserva = todosAsientos.filter((a) => {
          ...
          return a.DNI === reserva.DNI && fechaAsiento.getTime() === fechaReservaBase.getTime();
        });
            ...
            {qrLoading ? (
              ...
              <div className="flex flex-col items-center">
                <div className="bg-white p-4 rounded-lg mb-3">
                  <img src={qrCode} alt="QR Code de la reserva" className="w-48 h-48" />
                </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-blue-200 text-sm">
                  Recuerda llegar 15 minutos antes de la función.
                </p>
              </div>
            </div>
          </div>
