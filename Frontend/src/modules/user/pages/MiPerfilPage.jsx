...
export default function MiPerfilPage() {
    ...
    const load = async () => {
      ...
      try {
        ...
        try {
          ...
          my.sort(
            (a, b) => new Date(a.funcion?.fechaHoraFuncion) - new Date(b.funcion?.fechaHoraFuncion)
          );
          setReservas(my);
        } catch (e) {
  ...
  const reservasActivas = reservas.filter(
    (r) => r.estado === ESTADOS_RESERVA.ACTIVA && new Date(r.funcion?.fechaHoraFuncion) >= now
  );
            ...
            <div className="mt-4 flex flex-wrap justify-center md:justify-start gap-3 text-gray-400 text-xs sm:text-sm">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 bg-white/5 rounded-full border border-white/10 hover:bg-white/10 transition-colors">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.251 8.251 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z"
                    clipRule="evenodd"
                  />
                </svg>
              ...
              {telefono && (
                <div className="flex items-center gap-2 px-3 py-1.5 bg-white/5 rounded-full border border-white/10 hover:bg-white/10 transition-colors">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M1.5 4.5a3 3 0 0 1 3-3h1.372c.86 0 1.61.586 1.819 1.42l.453 1.814a1.875 1.875 0 0 1-1.121 2.183l-1.103.441a1.875 1.875 0 0 0-1.066 2.393 12.83 12.83 0 0 0 4.639 4.639 1.875 1.875 0 0 0 2.393-1.066l.441-1.103a1.875 1.875 0 0 1 2.183-1.121l1.814.453c.834.209 1.42.959 1.42 1.819V19.5a3 3 0 0 1-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5Z"
                      clipRule="evenodd"
                    />
                  </svg>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-900/40 p-8 rounded-3xl border border-white/5 backdrop-blur-sm">
            ...
            {sortedReservas.length > 0 ? (
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-400">
                        {reserva.estado === ESTADOS_RESERVA.ACTIVA
                          ? 'Reservada el'
                          : 'Fecha de función:'}{' '}
                        {formatDateTime(reserva.fechaHoraReserva ?? reserva.fechaHoraFuncion)}
                      </p>
                    </div>
                  </div>
                ))}
              ...
              <p className="text-gray-400 text-center py-10 opacity-50">
                Explora nuestra cartelera.
              </p>
            )}
          </div>
        </div>
