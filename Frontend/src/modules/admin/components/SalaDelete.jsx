        ...
        <div className="mb-6 p-5 bg-slate-700/50 rounded-lg mx-auto">
          ...
          <div className="space-y-3">
            <p className="text-gray-300 text-center text-sm">
              Ubicación: <span className="font-semibold text-purple-400">{sala.ubicacion}</span>
            </p>
            <p className="text-gray-300 text-center text-sm">
              Capacidad: <span className="font-semibold text-purple-400">{sala.capacidad} asientos</span>
            </p>
          </div>
        </div>
