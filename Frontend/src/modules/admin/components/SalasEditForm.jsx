...
import { getAsientosBySala } from "../../../api/Salas.api.js";
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-end gap-4 pt-4">
                  ...
                  <Button 
                    ...
                    color
                    className="bg-gradient-to-r from-green-600 to-teal-500 hover:from-green-700 hover:to-teal-600 text-white rounded-lg"
                  >
