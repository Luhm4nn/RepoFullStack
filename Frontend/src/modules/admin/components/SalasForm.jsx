...
export default function SalasForm({ onSubmit, onCancel }) {
          ...
          {({ isSubmitting, values }) => (
            <Form className="space-y-4">
              <div className="grid grid-cols-1 gap-4 ">
                {/* Nombre Sala */}
                <div>
                  <label className="block text-white font-medium mb-2" htmlFor='nombreSala'>
                        Nombre de la Sala *
                      </label>
                  <Field
                    as={TextInput}
                ...
                {/* Ubicacion */}
                <div>
                  <label className="block text-white font-medium mb-2" htmlFor='ubicacion'>
                        Ubicación *
                      </label>
                  <Field
                    as={Select}
                  ...
                  >
                    <option
                      value=""
                      className="bg-slate-700 border-slate-600 hover:bg-white/10 text-white"
                    >
                ...
                {/* Filas */}
                <div>
                  <label className="block text-white font-medium mb-2" htmlFor='filas'>
                        Filas *
                      </label>
                  <Field
                    as={TextInput}
                ...
                {/* Asientos por fila */}
                <div>
                  <label className="block text-white font-medium mb-2" htmlFor='asientosPorFila'>
                        Asientos por fila *
                      </label>
                  <Field
                    as={TextInput}
                ...
                {values.filas &&
                  values.asientosPorFila &&
                  parseInt(values.filas) > 0 &&
                  parseInt(values.filas) < 26 &&
                  parseInt(values.asientosPorFila) > 0 &&
                  parseInt(values.asientosPorFila) < 26 && (
                    <div>
