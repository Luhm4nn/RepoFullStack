    ...
    return (
      <div className="text-center p-4">
        <p className="text-white text-xl">
          No se encontraron Películas cargadas.
        </p>
        <button
        ...
        <Table>
          <TableHead>
            <TableRow className="bg-slate-800/50 text-white pointer-events-none border-slate-700">
              <TableHeadCell className="bg-slate-800/50 text-white">
                Título
              </TableHeadCell>
              <TableHeadCell className="bg-slate-800/50 text-white">
                Director
            ...
            {peliculas.length === 0 ? (
              ...
              peliculas.map((pelicula) => (
                ...
                >
                  ...
                  <TableCell>
                    {pelicula.generoPelicula || "Sin género"}
                  </TableCell>
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M20.25 7.5l-8.954-4.477a.75.75 0 0 0-.692 0L2.25 7.5m18 0v9a.75.75 0 0 1-.75.75h-4.5m5.25-9L12 12.75m0 0L3.75 7.5m8.25 5.25v9"
                    />
                  </svg>
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5A2.25 2.25 0 0 1 5.25 5.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75"
                    />
                  </svg>
                  <span>
                    {pelicula.fechaEstreno
