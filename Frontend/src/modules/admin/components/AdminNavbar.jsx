      ...
      <nav className="bg-gradient-to-r from-indigo-800 via-purple-800 to-pink-700 py-4 px-5 border-b border-slate-800 sticky top-0 z-50">
        <div className="flex items-center justify-between mx-auto">
          ...
          <div className="flex items-center md:order-2 ml-auto mr-0 md:mr-4 gap-2">
            ...
            <Dropdown
              label={
                <div className="w-14 h-14 bg-gradient-to-r cursor-pointer from-green-600 to-teal-600 rounded-full flex items-center justify-center text-white text-2xl font-bold uppercase">
              ...
              className="!bg-slate-800 !text-white !border-slate-700 rounded-lg shadow-xl min-w-[16rem]"
              arrowIcon={false}
            >
